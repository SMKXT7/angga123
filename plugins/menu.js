 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
   ...
   const sections = [
   {
	...
	rows: [
	    {title: `⚡ ${pmenus} 𝚂𝙿𝙴𝙴𝙳 𝙱𝙾𝚃`, rowId: ".ping", description: "M̼E̼N̼A̼M̼P̼I̼L̼K̼A̼N̼ K̼E̼C̼E̼P̼A̼T̼A̼N̼ R̼E̼S̼P̼O̼N̼ B̼O̼T̼  S̼M̼K̼X̼T̼7̼"},
	    {title: `⏰ ${pmenus} 𝚁𝚄𝙽𝚃𝙸𝙼𝙴 𝙱𝙾𝚃`, rowId: ".runtime", description: "𝙼𝙴𝙽𝙰𝙼𝙿𝙸𝙻𝙺𝙰𝙽 𝚆𝙰𝙺𝚃𝚄 𝙱𝙾𝚃  𝚂𝙼𝙺𝚇𝚃𝟽 𝙱𝙴𝚁𝙹𝙰𝙻𝙰𝙽"}, 
	    {title: `💌 ${pmenus} 𝙾𝚆𝙽𝙴𝚁 𝙱𝙾𝚃`, rowId: ".creator", description: "MENAMPILKAN INFO TENTANG OWNER"},
	]
    },{
