...
global.APIs = { // API Prefix
  ...
  candra : 'api.smkxt7.my.id'
  darkcose : 'https://darkcoder.xyz/'
}
global.APIKeys = { // APIKey Here
  ...
  'https://darkcoder.xyz': 'aa39qwmAmQm5ZFv8hHOW',
  'api.smkxt7.my.id': 'smkxt7'
}
// Kata APIKEY itu isi dengan apikey lu sendiri, dengan beli ke website itu

/*============== WATERMARK ==============*/
global.wm = '                「 ន៣ƙ✗Ƭ7 𝙱𝙾𝚃 汉  」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘ន៣ƙ✗Ƭ7 - 乃ㄖㄒ ꒱ ‧₊˚꒷︶꒷꒥꒷'
...
global.packname2 = 'ᴄʀᴇᴀᴛᴇᴅ ʙʏ ន៣ƙ✗Ƭ7 - ᖲ០Ƭ'
